...
/*
 * Base ERC20 implementation with total supply minted to owner
 * This implementation is not compatible with other Solidity contracts because of its storage layout
 * To get a compatible version use the extended ERC20 implementation
 */
